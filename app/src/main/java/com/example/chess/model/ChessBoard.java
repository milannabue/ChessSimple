...
/// stores information about the board. Mainly the 2D array that represents all squares and the pieces on those squares
...
public class ChessBoard {
    ...
    public void movePiece(Position start, Position end, boolean force) {
        if ((board[start.getRow()][start.getColumn()] != null &&
                board[start.getRow()][start.getColumn()].isValidMove(end, board)) || force) {
